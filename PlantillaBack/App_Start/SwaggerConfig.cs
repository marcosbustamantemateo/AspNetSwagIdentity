...
namespace PlantillaBack
{
    public class SwaggerConfig
    {
        ...
        {
            return Path.Combine(System.Web.HttpRuntime.AppDomainAppPath, "bin", "JsonWebTokensWebApi.xml");
        }
        ...
        public static void Register()
        {
            ...
            GlobalConfiguration.Configuration
                ...
                .EnableSwagger(c =>
                {
                    ...
                    c.SingleApiVersion("v1", "API Piquitos")
                        .Description("Documentación de la API del proyecto de piquitos")
                        .TermsOfService("Términos de servicio.")
                        .Contact(x => x
                            .Name("Ansotec S.L")
                            .Url("http://www.ansotec.es")
                            .Email("info@ansotec.es"))
                        .License(x => x
                            .Name("Licencia")
                            .Url("http://www.ansotec.es/license"));
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        // additional fields by chaining methods off SingleApiVersion.
                        //
                        c.SingleApiVersion("v1", "PlantillaBack");
